...
1) Highlight code. Hit Cmd+K to prompt an edit.
2) Open chat by clicking the right-bar button (on the top-right).
...
3) Hover over a lint error. Click "Fix in chat."
4) Hover over a terminal error. Click "Auto-Debug".
